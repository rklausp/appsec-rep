package br.com.cwi.loginapp.config;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests().antMatchers(POST, "/usuarios/email").permitAll()
                .and()
                .authorizeRequests().antMatchers(POST, "/senha/esqueci-senha/{email}").permitAll()
                .and()
                .authorizeRequests().antMatchers(POST, "/senha/recuperar-senha").permitAll()
                .and()
